        ...
        @foreach($classrooms as $classrooms)
            ...
            <td>{{ $classrooms->classroom_status }}</td>
                <td>
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('classrooms.show', [$classrooms->classroom_id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="{{ route('classrooms.edit', [$classrooms->classroom_id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
